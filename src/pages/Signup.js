        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.inputContainer}>
                    <Image style={styles.inputIcon} source={{ uri: 'https://png.icons8.com/message/ultraviolet/50/44556/name' }} />
                ...
                <View style={styles.signupTextCont}>
                    ...
                    <TouchableOpacity onPress={Actions.pop}><Text style={styles.signupButton}>Sign in</Text></TouchableOpacity>
                </View>
